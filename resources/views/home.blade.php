...
<html lang="en">
  ...
  <head>
    ...
    <title>Vuter Adda Restaurant </title>
<!--
                    ...
                    <nav class="main-nav">
                       ...
                       <a  class="menu-trigger" >
                        ...
                        -->
                            ...
                            <!-- <li class=""><a rel="sponsored" href="" target="_blank">External URL</a></li> -->
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright Voot Er Adda Co.
                        
                        <br>Design: By Salman</p>
                    </div>
                </div>
            </div>
        </div>
